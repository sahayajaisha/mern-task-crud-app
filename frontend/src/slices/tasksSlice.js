...
export const addTaskToServer = createAsyncThunk(
    ...
    async (task,{rejectWithValue}) => {
         ...
         // Validate the task before sending to the server
if (!task||!task.title||!task.description){
    return rejectWithValue({error:'Task not added empty field not allowed'})
...
export const updateTaskInServer = createAsyncThunk(
    ...
    async (task,{rejectWithValue}) => {
        ...
        if(!task||!task.title||!task.description){
            return rejectWithValue({error:'Task not Updated:empty field not allowed'})
...
const tasksSlice = createSlice({
    ...
    //             state.successMessage = 'Task updated successfully!'; //updatemsg
